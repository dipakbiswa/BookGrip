      ...
      @section('title', "Book Scout")
        ...
        <div class="flex items-center justify-between p-4 mb-8 text-sm font-semibold text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-800 rounded-lg shadow-md focus:outline-none focus:shadow-outline-purple">
          ...
          <div class="flex items-center">
            ...
            <form action="{{ route('book-scout-post') }}" method="post">
                @csrf
      ...
      <div class="grid gap-6 mb-8 md:grid-cols-2">
        <div class="min-w-0 p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
          <div class="container" style="position: relative;
              ...
              width: 100%;
              padding-top: 56.25%;">
                <iframe class="responsive-iframe" src="https://www.youtube.com/embed/ZbSugw7d0bk?si=AaIF8jxhwdfBMHo5" style="position: absolute;
                top: 0;
                left: 0;
                bottom: 0;
                right: 0;
        ...
        @else
            <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                ...
                <h2 class="text-xl font-semibold text-gray-700 dark:text-gray-200">
                    Upgrade Your Subscription to Get Access to Book Scout
                </h2><br>
                <p class="text-sm text-gray-600 dark:text-gray-400">
                    Your current subscription status does not include access to Book Scout. Please upgrade your subscription to keep using the Book Scout and the other powerful BookGrip tools.
                </p><br>
