<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <!-- How did you find us? -->
        <div class="mt-4">
            <x-input-label for="found_at" :value="__('How did you find us?')" />

            <x-text-input class="block mt-1 w-full"
                            type="text"
                            name="found_at" placeholder="Facebook" autocomplete="found_at" />

            <x-input-error :messages="$errors->get('found_at')" class="mt-2" />
        </div>
